...
if __name__ == "__main__":
    ...
    predictor = PredictClassification_7(
        ...
        s3_bucket=s3_bucket,
        output_base_path=f"ml-data/stocks/{predictor_name}.simulate_trade_5.{args.suffix}"
    )

    simulate_input_base_path = f"ml-data/stocks/preprocess_1.{args.suffix}"
    simulate_output_base_path = f"ml-data/stocks/simulate_trade_5.{args.suffix}"
    test_preprocess_base_path = f"ml-data/stocks/preprocess_3.{args.suffix}"
    test_output_base_path = f"ml-data/stocks/forward_test_5.{predictor_name}.{args.suffix}"
