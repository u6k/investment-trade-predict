...
def backtest_singles():
    ...
    input_preprocess_base_path = "ml-data/stocks/preprocess_3.test"
    input_model_base_path = "ml-data/stocks/predict_3_preprocess_3.test"
    output_base_path = "ml-data/stocks/simulate_trade_2_backtest.test"
    ...
    df_companies_result.to_csv("local/companies.simulate_trade_2_backtest.csv")
    L.info("finish")
